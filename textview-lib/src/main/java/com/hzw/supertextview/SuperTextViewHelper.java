...
public class SuperTextViewHelper {
    ...
    public SuperTextViewHelper(TextView view, AttributeSet attrs) {
        ...
        int gradientOrientation = typedArray.getInt(R.styleable.SuperTextView_bg_gradient_orientation, 0);
        int startColor = typedArray.getColor(R.styleable.SuperTextView_bg_gradient_start_color, 0);
        int centerColor = typedArray.getColor(R.styleable.SuperTextView_bg_gradient_center_color, 0);
        int endColor = typedArray.getColor(R.styleable.SuperTextView_bg_gradient_end_color, 0);
        int normalColor = typedArray.getColor(R.styleable.SuperTextView_normal_color, 0);
        int disableColor = typedArray.getColor(R.styleable.SuperTextView_disable_color, 0);
        int pressedColor = typedArray.getColor(R.styleable.SuperTextView_pressed_color, 0);
        mStrokeColor = typedArray.getColor(R.styleable.SuperTextView_stroke_color, 0);
        mStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_stroke_width, 0);
        int radius = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_radius, 0);
        int radiusLT = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_radius_left_top, 0);
        int radiusRT = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_radius_right_top, 0);
        int radiusRB = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_radius_right_bottom, 0);
        int radiusLB = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_radius_left_bottom, 0);
        typedArray.recycle();
